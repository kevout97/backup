...
class InterfaceController: WKInterfaceController {
 ...
 //     if (newContext.recentURLs == nil || newContext.recentURLs!.count == 0) {
        infoLabel.setText("Ingresa a una conferencia desde tu telefono, para iniciar.")
...
//          guard let controller = table.rowController(at: index) as? MeetingRowController else {return}
...
//      guard let controller = table.rowController(at: rowIndex) as? MeetingRowController else {return}
