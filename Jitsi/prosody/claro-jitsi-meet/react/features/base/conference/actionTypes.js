...
/**
 * The type of (redux) action which signals that a specific conference was left after a network fail.
 *
 * {
 *     type: CONFERENCE_FAILED_LEFT
 * }
 */
export const CONFERENCE_FAILED_LEFT = 'CONFERENCE_FAILED_LEFT';
