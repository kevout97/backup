...
const SECONDARY_BUTTON_ID='modal-dialog-secondary-button';
...
class StatelessDialog extends Component<Props> {
    ...
    _onSecondaryAction(value){
        const { onSecondaryAction } = this.props;
        onSecondaryAction && onSecondaryAction(value);
    }
    ...
    _renderSecondaryButton(){ 
        ...
        return (
            <Button
                ...
                secondaryHide = { this.props.secondaryHide }
                key = 'secondary'
                onClick = { this._onSecondaryAction }
                type = 'button'>
                { t(this.props.secondaryText || 'dialog.secondaryButtonText') }
            </Button>
        );
