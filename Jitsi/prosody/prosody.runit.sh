...
PROSOSY_CONTAINER="jitsi-prosody"
mkdir -p /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody/{conf.d,certs}

cat<<-EOF > /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody/conf.d/claroconnect.com.cfg.lua
...
cat<<-EOF > /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody/certs/jitsi.claroconnect.com.pem
-----BEGIN CERTIFICATE-----
...
cat<<-EOF > /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody/certs/jitsi.claroconnect.com.key
...
chown 101:102 -R /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody

docker run -td --name $JICOFO_PROS_CONTAINER --privileged \
    -p 5222:5222 \
    -p 5280:5280 \
    -p 5347:5347 \
    -v /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody/conf.d/claroconnect.com.cfg.lua:/etc/prosody/conf.d/claroconnect.com.cfg.lua:z \
    -v /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody/certs/jitsi.claroconnect.com.pem:/etc/prosody/certs/jitsi.claroconnect.com.pem:z \
    -v /var/containers/$JICOFO_PROS_CONTAINER/etc/prosody/certs/jitsi.claroconnect.com.key:/etc/prosody/certs/jitsi.claroconnect.com.key:z \
    -v /usr/share/zoneinfo:/usr/share/zoneinfo:ro \
    -e "TZ=America/Mexico_City" \
    -e "JICOFO_AUTH_DOMAIN=auth.claroconnect.com" \
    -e "JICOFO_FOCUS_PASSWORD=fa8DmGQk" \
    -e "JICOFO_JVB_PASSWORD=JWlc6CDg" \
    -e "JICOFO_JVB_USER=jvb" \
    -e "JICOFO_FOCUS_USER=focus" \
    docker-source-registry.amxdigital.net/jitsi-jp-prosody