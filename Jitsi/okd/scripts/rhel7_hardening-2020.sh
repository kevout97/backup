...
for i in bin daemon adm lp sync shutdown halt mail games ftp avahi-autoipd tss postfix systemd-bus-proxy systemd-network operator dockerroot tcpdump insights nxautomation; do 
     userdel -r $i ;
done
