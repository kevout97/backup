...
# /var/lib/etcd 25G
lvcreate -L 25G -n lv_var_lib_etcd datavg1
...
# /var/lib/docker 150G
lvcreate -L 150G -n lv_var_lib_docker datavg1
...
lvcreate -L 150G -n lv_var_lib_containers datavg1
...
# /var/log 50G
lvcreate -L 50G -n lv_var_log datavg1
