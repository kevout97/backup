...
#############################################################
#                                                           #
#  Runit para despliegue de Elasticsearch 5.6.9 en cluster  #
#                                                           #
#############################################################
...
# https://www.elastic.co/guide/en/elasticsearch/reference/5.6/modules-node.html
...
ELASTIC_DISCOVERY_ZEN_PING_UNICAST_HOSTS="10.23.144.138,10.23.144.139,10.23.144.140,10.23.144.135,10.23.144.137" # Unicast discovery requires a list of hosts to use that will act as gossip routers.
